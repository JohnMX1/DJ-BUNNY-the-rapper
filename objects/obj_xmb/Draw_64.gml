...
draw_text_transformed(iconx[0], icony[0]+32*5, xbar_icons[0], 4, 4, 0);
...
draw_text_transformed(iconx[1], icony[1]+32*5, xbar_icons[1], 4, 4, 0);
...
draw_text_transformed(iconx[2], icony[2]+32*5, xbar_icons[2], 4, 4, 0);
...
draw_text_transformed(iconx[3], icony[3]+32*5, xbar_icons[3], 4, 4, 0);
